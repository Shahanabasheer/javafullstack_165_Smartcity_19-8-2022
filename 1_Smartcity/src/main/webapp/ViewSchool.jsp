 ...
 <div id="sessions">
	...
	<c:forEach items="${list}" var="s">
		...
		<div class="admin_viewSchool" id="">
			...
			<div class="viewSchool_div1" id="viewSchoolDiv1" name="viewSchoolDiv1">
			...
			<div class="viewSchool_div2" id="viewSchoolDiv2">
				...
				<input type="button" name="viewMore" id="view_more" value="View More">
				</a>
					<%
					} else {
					%> <a
					href="User_ViewMoreSchool.jsp?School_Id=${s.getSchool_id()}"><input
